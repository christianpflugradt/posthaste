...
2026-03-05 19:02 | productivity | Added deterministic `tasks` helper (`make tasks ROLE=...`) for concise top-5 backlog listing in index order. | scripts/tasks.sh, Makefile, AGENTS.md, backlog/README.md, prompt.txt, docs/00-governance/runtime-contract.md, docs/00-governance/policy-changelog.md
2026-03-05 19:08 | productivity | Added `make go-ready ROLE=...` as one-command active-context pre-check (runtime refs + preflight + governance guard + tasks preview). | scripts/go_ready.sh, Makefile, AGENTS.md, backlog/README.md, prompt.txt, docs/00-governance/runtime-contract.md, docs/00-governance/policy-changelog.md
2026-03-05 19:16 | governance | Condensed duplicated active-command instructions by centralizing detailed `go` steps in runtime-contract and trimming repeated wording in AGENTS/prompt/README. | AGENTS.md, prompt.txt, README.md, docs/00-governance/runtime-contract.md, docs/00-governance/policy-changelog.md
2026-03-05 19:20 | runtime | Added `go all` interaction contract and loop pre-check command (`make go-all-ready`) across governance/runtime docs and tooling. | AGENTS.md, backlog/README.md, docs/00-governance/runtime-contract.md, prompt.txt, README.md, Makefile, scripts/go_all_ready.sh, docs/00-governance/policy-changelog.md
2026-03-06 07:43 | quality-security | Enforced QE/SE post-gate sync/validation rule: after gate updates run PB-scoped index-sync and role-scoped preflight before completion. | AGENTS.md, backlog/README.md, prompt.txt, docs/00-governance/runtime-contract.md, docs/00-governance/roles/quality-engineer.md, docs/00-governance/roles/security-engineer.md, docs/00-governance/policy-changelog.md
